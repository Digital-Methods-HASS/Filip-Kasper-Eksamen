...
```
We want to create a graph that shows us the average unemployed people from 1914 to 1918 or doing ww1

We do this by creating a new value that we call selected_data 
...
# we then check the struckure of the data 
str(data02)
```
...
We have now created 9 graph 

The first 3 show us the average number of unemployed over the span of 4 to 6 years
